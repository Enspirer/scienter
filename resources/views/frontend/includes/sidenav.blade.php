<div class="sidenav">
    <div class="side-top">
        <div class="side-title-wrapper">
            <span class="segoe-ui-bold">Home</span>
        </div>
    </div>
    <div class="side-middle">
        <span class="side-middle-icon"><svg xmlns="http://www.w3.org/2000/svg" width="48" height="59" viewBox="0 0 48 59">
  <g id="Group_48" data-name="Group 48" transform="translate(-57 -511)">
    <line id="Line_2" data-name="Line 2" x2="29" transform="translate(63 530.5)" fill="none" stroke="#fff" stroke-width="2"/>
    <line id="Line_3" data-name="Line 3" x2="42" transform="translate(63 540.5)" fill="none" stroke="#fff" stroke-width="2"/>
    <line id="Line_4" data-name="Line 4" x2="29" transform="translate(63 551.5)" fill="none" stroke="#fff" stroke-width="2"/>
    <text id="_01" data-name="01" transform="translate(57 524)" fill="#fff" font-size="12" font-family="SegoeUI, Segoe UI"><tspan x="0" y="0">01</tspan></text>
    <text id="_05" data-name="05" transform="translate(57 567)" fill="#fff" font-size="12" font-family="SegoeUI, Segoe UI"><tspan x="0" y="0">05</tspan></text>
  </g>
</svg>
</span>
    </div>
    <div class="side-bottom">
        <ul class="siderbar-list">
            ...
            <li>
                <span>
                    <svg id="line-chart-662" xmlns="http://www.w3.org/2000/svg" width="29.014" height="20.076" viewBox="0 0 29.014 20.076">
                        <g id="Group_46" data-name="Group 46" transform="translate(0 0)">
                            <ellipse id="Ellipse_71" data-name="Ellipse 71" cx="1.406" cy="1.406" rx="1.406" ry="1.406" transform="translate(0.458 16.808)" fill="#fff"/>
                            <ellipse id="Ellipse_72" data-name="Ellipse 72" cx="1.406" cy="1.406" rx="1.406" ry="1.406" transform="translate(13.775 12.936)" fill="#fff"/>
                            <ellipse id="Ellipse_73" data-name="Ellipse 73" cx="1.406" cy="1.406" rx="1.406" ry="1.406" transform="translate(8.533 8.159)" fill="#fff"/>
                            <path id="Path_2245" data-name="Path 2245" d="M31.708,130.318,26.327,136c-.03.313.113.55.613.578l5.381-5.68A.59.59,0,0,0,31.708,130.318Z" transform="translate(-23.293 -119.626)" fill="#fff"/>
                            <path id="Path_2246" data-name="Path 2246" d="M99.978,131.721l-2.23-2.131c-.38,0-.558.227-.58.61l2.252,2.153C99.891,132.345,100.066,132.119,99.978,131.721Z" transform="translate(-85.984 -118.982)" fill="#fff"/>
                            <path id="Path_2247" data-name="Path 2247" d="M2,177.973a1.156,1.156,0,1,1-1.156,1.156A1.157,1.157,0,0,1,2,177.973m0-.842a2,2,0,1,0,2,2,2,2,0,0,0-2-2Z" transform="translate(0 -161.051)" fill="#fff"/>
                            <path id="Path_2248" data-name="Path 2248" d="M72.071,104.007a1.156,1.156,0,1,1-1.156,1.156,1.157,1.157,0,0,1,1.156-1.156m0-.842a2,2,0,1,0,2,2,2,2,0,0,0-2-2Z" transform="translate(-62.008 -95.598)" fill="#fff"/>
                            <path id="Path_2249" data-name="Path 2249" d="M116.528,145.531a1.156,1.156,0,1,1-1.156,1.156,1.157,1.157,0,0,1,1.156-1.156m0-.842a2,2,0,1,0,2,2,2,2,0,0,0-2-2Z" transform="translate(-101.348 -132.343)" fill="#fff"/>
                            <path id="Path_2250" data-name="Path 2250" d="M219.357,38.269a1.156,1.156,0,1,1-1.156,1.156,1.157,1.157,0,0,1,1.156-1.156m0-.842a2,2,0,1,0,2,2,2,2,0,0,0-2-2Z" transform="translate(-192.34 -37.427)" fill="#fff"/>
                            <path id="Path_2251" data-name="Path 2251" d="M150.323,62.848a.59.59,0,0,0-.613-.578l-5.381,5.68h0l-4.035,4.259c-.03.313.113.55.613.578l5.381-5.68h0Z" transform="translate(-124.143 -59.411)" fill="#fff"/>
                            <ellipse id="Ellipse_74" data-name="Ellipse 74" cx="1.406" cy="1.406" rx="1.406" ry="1.406" transform="translate(25.61 0.592)" fill="#fff"/>
                        </g>
                    </svg>
                </span>
            </li>
